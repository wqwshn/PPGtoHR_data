...
//			allData[7] = Pulse_IIC2[2];
			...
			allData[2] = ADC_1to4Voltages[0][0];
			allData[3] = ADC_1to4Voltages[0][1];
			allData[4] = ADC_1to4Voltages[0][2];
			
			allData[5] = ADC_1to4Voltages[1][0];
			allData[6] = ADC_1to4Voltages[1][1];
			allData[7] = ADC_1to4Voltages[1][2];
			
			allData[8] = ADC_1to4Voltages[2][0];
			allData[9] = ADC_1to4Voltages[2][1];
			allData[10] = ADC_1to4Voltages[2][2];
			
			allData[11] = ADC_1to4Voltages[2][0];
			allData[12] = ADC_1to4Voltages[2][1];
			allData[13] = ADC_1to4Voltages[2][2];

			allData[14] = ACC_XYZ[1];
			allData[15] = ACC_XYZ[0];
			allData[16] = ACC_XYZ[3];
			allData[17] = ACC_XYZ[2];
			allData[18] = ACC_XYZ[5];
			allData[19] = ACC_XYZ[4];
...
//			Pulse_IIC_all[Pulse_IIC_times++] = Pulse_IIC2[0] & 0x03;
//			Pulse_IIC_all[Pulse_IIC_times++] = Pulse_IIC2[1];
//			Pulse_IIC_all[Pulse_IIC_times++] = Pulse_IIC2[2];

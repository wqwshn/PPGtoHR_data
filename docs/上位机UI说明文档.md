...
| 2026-04-15 | 多光谱原始数据包支持(33字节): 新增 RawDataPacket 解析(Green+Red+IR三通道PPG + 16-bit ACC + 陀螺仪); 串口双包类型自动检测(0xAA0xBB/0xAA0xCC); PPG波形卡片(左侧绿光, 右侧红光+红外上下); HR/Raw 模式自动切换; --raw 模拟模式(100Hz) |

...
进一步查阅：[原始数据录制文件结构说明](原始数据录制文件结构说明.md)、[MAX30101项目配置说明](MAX30101项目配置说明.md)、[ADS124S06配置说明](ADS124S06配置说明.md)、[LSM9DS1配置说明](LSM9DS1配置说明.md)。配置变化后应重新核对本指南中的默认值、数据单位和采样时间轴。
